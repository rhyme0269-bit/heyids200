...
function ItemCard({ item, index }: { item: KeyValueListData["items"][number]; index: number }) {
  const inner = (
    <>
      ...
      {d.title && (
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-xs font-semibold tracking-[0.15em] text-stone-400 uppercase">Links</span>
            <div className="h-px w-8 bg-stone-300" />
          </div>
